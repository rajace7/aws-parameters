parameters = [
  { name="dev.frontend.catalogue_url", value="http://catalogue-dev.rpadaladevops.online:80/" },
  { name="dev.frontend.cart_url", value="http://cart-dev.rpadaladevops.online:80/" },
  { name="dev.frontend.user_url", value="http://user-dev.rpadaladevops.online:80/" },
  { name="dev.frontend.shipping_url", value="http://shipping-dev.rpadaladevops.online:80/" },
  { name="dev.frontend.payment_url", value="http://payment-dev.rpadaladevops.online:80/" },
  ...
  { name="dev.user.redis_host", value="elasticache-dev-elasticache.yoop0r.ng.0001.use1.cache.amazonaws.com" },
  { name="dev.user.mongo_endpoint", value="mongodb://mongod-dev.rpadaladevops.online:27017/catalogue" },
  { name="dev.cart.redis_host", value="elasticache-dev-elasticache.yoop0r.ng.0001.use1.cache.amazonaws.com" },
  { name="dev.cart.catalogue_host", value="catalogue-dev.rpadaladevops.online" },
  { name="dev.cart.catalogue_port", value="80" },
  { name="dev.shipping.cart_endpoint", value="cart-dev.rpadaladevops.online:80" },
  { name="dev.rds.db_host", value="rds-dev-rds.cluster-c9wjh0h13wu6.us-east-1.rds.amazonaws.com" },
...
passwords = [
  ...
  { name = "dev.user.mongo_url", value = "mongodb://roboshop:roboshop123456@docdb-dev.cluster-c9wjh0h13wu6.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" }
]
